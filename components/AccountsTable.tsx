...
export default function AccountsTable() {
    ...
    return (
        <div className='grid grid-cols-12 min-h-screen border-t border-neutral'>
            <div className='col-span-5 border-r border-neutral sm:col-span-3'>
                <AccountsHeader />
            </div >
                                            ...
                                            <div className="input-group relative">
                                                <select className="select select-sm w-fit select-bordered bg-none">
                                                    ...
                                                    {transactions.map((transaction) => {
                                                        // if (account.type === transaction.category) {
                                                        return (<option>{transaction.category}</option>)
                                                        // }
                                                    })}
                                                </select>
