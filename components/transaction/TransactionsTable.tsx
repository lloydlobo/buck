...
function AccountType({ accounts }: { accounts: any }) {
    ...
    return (
        <select className="select-bordered select w-full bg-none">
                    ...
                    <tr>
                        ...
                        <th>
                            <input
                                type="text"
                                placeholder=""
                                className="input-bordered input input-md w-24  sm:w-32 "
                            />
                        </th>
                        {/* Account */}
                        <th>
                            <div className="form-control">
                                <div className="input-group relative">
                                    ...
                                    {/* </select> */}
                                    <span className="pointer-events-none absolute inset-y-0 right-0 ml-3 flex items-center bg-transparent pr-2 text-info">
                                        <svg
                                            className="h-6 w-6"
                        ...
                        <th>
                            <div className="flex items-center gap-1">
                                ...
                                <input
                                    className="input-bordered input input-sm w-[16ch] rounded-full text-right"
                                    type="text"
                                    placeholder="0.00"
                                />
                            </div>
                        ...
                        <th>
                            <div className="input-group relative">
                                ...
                                <span className="pointer-events-none absolute inset-y-0 right-0 ml-3 flex items-center bg-transparent pr-2">
                                    <svg
                                        className="h-6 w-6"
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="none"
                            ...
                            <th>
                                <div className="flex items-center gap-1">
                                    ...
                                    <input
                                        ...
                                        className="input-bordered input input-sm mx-0 w-[16ch] rounded-full px-0 text-right"
                                        type={'number'}
                                        placeholder="0.00"
                                    />
                                </div>
                            ...
                            <th>
                                <div className="gap flex">
                                    ...
                                    <button
                                        ...
                                        className={`- square - ghost btn btn btn ${
...
const monthlySelect = () => (
    <select className="select-ghost select w-full max-w-xs">
