...
import { DropdownLink } from './menu/DropdownLink';

/**
 * MenuDropdown component.
 * @param {any} {children:menuName}:any
 * @returns {any}
 */
    ...
    return (
        <div className="w-56 text-right">
            <Menu as="div" className="relative inline-block text-left">
                <div>
                    <Menu.Button className={styleMenu().button}>
                        {menuName}
                        <ChevronDownIcon
                ...
                >
                    <Menu.Items className={styleMenu().items}>
...
const styleMenu = () => {
    return {
        button:
            ...
            ' text-sm font-medium hover:bg-opacity-30 focus:outline-none ' +
            ' focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75',
        items:
            'absolute right-0 mt-2 w-56 origin-top-right divide-y divide-base-100' +
            ' rounded-md shadow-lg bg-base-300 ring-1 ring-neutral ring-opacity-5 focus:outline-none',
    };
};
