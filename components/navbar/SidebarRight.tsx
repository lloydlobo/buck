...
export default function SidebarRight() {
    return (
        <div>
            <div className="">
                <div className="sticky top-20 my-6 xl:my-0 xl:mt-32 xl:w-[130px]">
                    <div className="hidden xl:block ">
                        <div className="flex flex-col gap-2 pb-6">
                            <h3 className="text-xs font-bold text-base-content/50">
                                Sponsors
                            </h3>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <path
                                            ...
                                            fill="#FF364E"
                                        ></path>
                                        <path d="M69.0011 21.3336H68.377H65.7321L65.7837 19.6334C64.7383 20.8889 63.1953 21.7218 61.129 21.7218C57.075 21.7218 54.2495 18.6359 54.2495 14.5303C54.2495 10.3719 57.048 7.23315 61.102 7.23315C63.0675 7.23315 64.554 7.99113 65.5994 9.14221V7.73437H68.9998L69.0011 21.3336ZM61.7531 18.6371C63.9238 18.6371 65.7284 17.0401 65.7284 14.5315C65.7284 11.9677 63.9238 10.3203 61.7531 10.3203C59.4779 10.3203 57.7777 12.0205 57.7777 14.5315C57.7875 16.9934 59.4816 18.6408 61.7567 18.6408L61.7531 18.6371Z"></path>
                                    </svg>
                    ...
                    <div className="carbonads-responsive mx-auto flex items-center justify-center">
                        <script
