...
export const Footer = () => {
    ...
    return (
        <footer className="footer items-center p-4 border-t border-base-300 shadow-inner text-neutral-content">
            <div className="items-center grid-flow-col">
                ...
                <p>Copyright © {currentYear} Bucket</p>
            </div>
...
/* <footer className="footer grid grid-col grid-cols-4 p-10 bg-base-200 text-base-content">
    <div className='flex justify-between h-3/4 flex-col'>
